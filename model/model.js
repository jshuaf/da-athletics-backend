...
exports.findEventsByTeam = teamID => Event.find({ team: teamID, }).lean().exec();

exports.updateEvent = (id, toUpdate) => Event.findByIdAndUpdate(id, toUpdate, { new: true, }).exec();
...
exports.updateTeam = (id, toUpdate) => Team.findByIdAndUpdate(id, toUpdate, { new: true, }).exec();
